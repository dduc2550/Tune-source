        ...
        <ul class="header-nav ms-3">
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#"
                    ...
                    <div class="avatar avatar-md">
                        <img class="avatar-img" src="admin/assets/img/avatars/10.png"
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <form method="POST" action="{{ route('admin.logout') }}">
                        ...
                        <button class="dropdown-item" type="submit">
                            <svg class="icon me-2">
                                <use
                                    xlink:href="admin/vendors/@coreui/icons/svg/free.svg#cil-account-logout">
                                </use>
                            </svg>Logout
                        </button>
                    </form>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
                <li class="breadcrumb-item">
                    <!-- if breadcrumb is single--><span>@yield("breadcrumd-item")</span>
                </li>
                <li class="breadcrumb-item active"><span>@yield("breadcrumd-item-active")</span></li>
            </ol>
        </nav>
    </div>
</header>
